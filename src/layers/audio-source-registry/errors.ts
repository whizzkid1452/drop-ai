export const AudioSourceRegistryErrorCode = {
  ...
  INVALID_LOOP_SLOT_ID: 'INVALID_LOOP_SLOT_ID',
  REGION_ID_CONFLICT: 'REGION_ID_CONFLICT',
  REGION_ATTACHMENT_NOT_FOUND: 'REGION_ATTACHMENT_NOT_FOUND',
  LOOP_SLOT_ID_CONFLICT: 'LOOP_SLOT_ID_CONFLICT',
  LOOP_SLOT_ATTACHMENT_NOT_FOUND: 'LOOP_SLOT_ATTACHMENT_NOT_FOUND',
  ...
  SOURCE_IMMUTABLE_METADATA_CHANGED: 'SOURCE_IMMUTABLE_METADATA_CHANGED',
