  ...
  act(() => {
    root.render(
      createElement(TrackComponent, {
        ...
        onAutomationWriteCancel: vi.fn().mockResolvedValue(undefined),
        onAutomationWriteCommit: vi.fn().mockResolvedValue(undefined),
        onAutomationWritePreview: vi.fn().mockResolvedValue(undefined),
