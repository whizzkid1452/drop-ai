...
import { LayerProvider } from '../web/context/layer-provider';
...
const CliTestContent = () => {
  ...
  return (
    <div
      style={{ padding: '20px', fontFamily: 'monospace', height: '100vh', display: 'flex', flexDirection: 'column' }}
    >
      <h1>CLI Logic Terminal (xterm.js)</h1>
      <div style={{ marginBottom: '10px', padding: '10px', border: '1px solid #ddd', background: '#f9f9f9' }}>
        <span>
          Status: <strong style={{ color: isPlaying ? 'green' : 'red' }}>{isPlaying ? 'PLAYING' : 'STOPPED'}</strong>
        </span>
