export const ProjectStateErrorCode = {
  ...
  TRACK_NOT_MIDI: 'TRACK_NOT_MIDI',
  LOOP_SLOT_NOT_FOUND: 'LOOP_SLOT_NOT_FOUND',
  LOOP_SLOT_NOT_EMPTY: 'LOOP_SLOT_NOT_EMPTY',
  LOOP_SLOT_NOT_PLAYING: 'LOOP_SLOT_NOT_PLAYING',
  LOOP_SLOT_OVERDUB_LIMIT_REACHED: 'LOOP_SLOT_OVERDUB_LIMIT_REACHED',
  LOOP_SLOT_SOURCE_MISSING: 'LOOP_SLOT_SOURCE_MISSING',
  ...
  PLUGIN_PRESET_NOT_FOUND: 'PLUGIN_PRESET_NOT_FOUND',
  PLUGIN_SIDECHAIN_NOT_SUPPORTED: 'PLUGIN_SIDECHAIN_NOT_SUPPORTED',
  AUTOMATION_TARGET_IN_USE: 'AUTOMATION_TARGET_IN_USE',
  AUTOMATION_LANE_NOT_FOUND: 'AUTOMATION_LANE_NOT_FOUND',
  INVALID_EDITOR_SELECTION: 'INVALID_EDITOR_SELECTION',
  EDITOR_SELECTION_EMPTY: 'EDITOR_SELECTION_EMPTY',
} as const;
