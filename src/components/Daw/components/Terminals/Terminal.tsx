  ...
  return (
    <div className={styles.container}>
      <div className={styles.content}>
        {activeTerminal === 'AGENT' ? <AgentTerminal /> : <CliTerminal />}
      </div>
      <div className={styles.footer}>
        ...
        >
          <span
            className={activeTerminal === 'AGENT' ? styles.activeIndicator : ''}
          >
            AGENT
          </span>
          <span>/</span>
          <span
            className={activeTerminal === 'CLI' ? styles.activeIndicator : ''}
          >
            CLI
          </span>
        </button>
